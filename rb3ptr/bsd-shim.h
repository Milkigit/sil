#define RB_HELPERS(NAME, TYPE, FIELD) \
        static inline struct NAME##_head *NAME##_RB_get_head(struct TYPE *container) { return &container->FIELD; } \
        static inline struct TYPE *NAME##_RB_get_container(struct NAME##_head *head) { return (struct TYPE *)((char *) head - offsetof(struct TYPE, FIELD)); } \
